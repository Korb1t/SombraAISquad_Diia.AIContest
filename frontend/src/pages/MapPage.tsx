...
const mockAddresses = [
  {
    id: 1,
    label: 'Україна, область Львівська, місто Львів, вулиця Володимира Великого 17',
    coords: [49.808059, 24.0128333],
  },
  {
    id: 2,
    label: 'Україна, область Львівська, місто Львів, вулиця Втіха 1',
    coords: [49.840318, 24.06686],
  },
  {
    id: 3,
    label: 'Україна, область Львівська, місто Львів, вулиця Брюховицька 29',
    coords: [49.863678, 23.969400],
  },
  {
    id: 4,
    label: 'Україна, область Львівська, місто Львів, вулиця Кримська 10',
    coords: [49.825014, 24.040053],
  },
  {
    id: 5,
    label: 'Україна, область Львівська, місто Львів, вулиця Степана Бандери 2',
    coords: [49.834689, 24.019800],
  },
  {
    id: 6,
    label: 'Україна, область Львівська, місто Львів, вулиця Городоцька 69',
    coords: [49.841158, 24.015249],
  },
  {
    id: 7,
    label: 'Україна, область Львівська, місто Львів, вулиця Петра Панча 18б',
    coords: [49.862157, 24.013245],
  },
  {
    id: 8,
    label: 'Україна, область Львівська, місто Львів, вулиця Огіркова 9а',
    coords: [49.852099, 24.034252],
  },
  {
    id: 9,
    label: 'Україна, область Львівська, місто Львів, вулиця Горбкова 16',
    coords: [49.856584, 24.012306],
  },
  {
    id: 10,
    label: 'Україна, область Львівська, місто Львів, вулиця Княгині Ольги 9',
    coords: [49.818302, 24.004208],
  },
] as const;
